...
set(Qt5PlatformCompositorSupport_VERSION_STRING 5.13.1)
...
function(_qt5_PlatformCompositorSupport_process_prl_file prl_file_location Configuration lib_deps link_flags)
    ...
    get_filename_component(_qt5_install_libs "${_qt5PlatformCompositorSupport_install_prefix}/lib" ABSOLUTE)
...
if (NOT TARGET Qt5::PlatformCompositorSupport)
    ...
    set(Qt5PlatformCompositorSupport_PRIVATE_INCLUDE_DIRS
        "${_qt5PlatformCompositorSupport_install_prefix}/include/QtPlatformCompositorSupport/5.13.1"
        "${_qt5PlatformCompositorSupport_install_prefix}/include/QtPlatformCompositorSupport/5.13.1/QtPlatformCompositorSupport"
    )
    ...
    foreach(_module_dep ${_Qt5PlatformCompositorSupport_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.13.1 ${_Qt5PlatformCompositorSupport_FIND_VERSION_EXACT}
