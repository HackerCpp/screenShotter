...
set(Qt5FontDatabaseSupport_VERSION_STRING 5.13.1)
...
function(_qt5_FontDatabaseSupport_process_prl_file prl_file_location Configuration lib_deps link_flags)
    ...
    get_filename_component(_qt5_install_libs "${_qt5FontDatabaseSupport_install_prefix}/lib" ABSOLUTE)
...
if (NOT TARGET Qt5::FontDatabaseSupport)
    ...
    set(Qt5FontDatabaseSupport_PRIVATE_INCLUDE_DIRS
        "${_qt5FontDatabaseSupport_install_prefix}/include/QtFontDatabaseSupport/5.13.1"
        "${_qt5FontDatabaseSupport_install_prefix}/include/QtFontDatabaseSupport/5.13.1/QtFontDatabaseSupport"
    )
    ...
    foreach(_module_dep ${_Qt5FontDatabaseSupport_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.13.1 ${_Qt5FontDatabaseSupport_FIND_VERSION_EXACT}
