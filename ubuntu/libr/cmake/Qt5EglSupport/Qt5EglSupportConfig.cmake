...
set(Qt5EglSupport_VERSION_STRING 5.13.1)
...
function(_qt5_EglSupport_process_prl_file prl_file_location Configuration lib_deps link_flags)
    ...
    get_filename_component(_qt5_install_libs "${_qt5EglSupport_install_prefix}/lib" ABSOLUTE)
...
if (NOT TARGET Qt5::EglSupport)
    ...
    set(Qt5EglSupport_PRIVATE_INCLUDE_DIRS
        "${_qt5EglSupport_install_prefix}/include/QtEglSupport/5.13.1"
        "${_qt5EglSupport_install_prefix}/include/QtEglSupport/5.13.1/QtEglSupport"
    )
    ...
    foreach(_module_dep ${_Qt5EglSupport_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.13.1 ${_Qt5EglSupport_FIND_VERSION_EXACT}
