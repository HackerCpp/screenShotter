...
set(Qt5FbSupport_VERSION_STRING 5.13.1)
...
function(_qt5_FbSupport_process_prl_file prl_file_location Configuration lib_deps link_flags)
    ...
    get_filename_component(_qt5_install_libs "${_qt5FbSupport_install_prefix}/lib" ABSOLUTE)
...
if (NOT TARGET Qt5::FbSupport)
    ...
    set(Qt5FbSupport_PRIVATE_INCLUDE_DIRS
        "${_qt5FbSupport_install_prefix}/include/QtFbSupport/5.13.1"
        "${_qt5FbSupport_install_prefix}/include/QtFbSupport/5.13.1/QtFbSupport"
    )
    ...
    foreach(_module_dep ${_Qt5FbSupport_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.13.1 ${_Qt5FbSupport_FIND_VERSION_EXACT}
