...
set(Qt5EventDispatcherSupport_VERSION_STRING 5.13.1)
...
function(_qt5_EventDispatcherSupport_process_prl_file prl_file_location Configuration lib_deps link_flags)
    ...
    get_filename_component(_qt5_install_libs "${_qt5EventDispatcherSupport_install_prefix}/lib" ABSOLUTE)
...
if (NOT TARGET Qt5::EventDispatcherSupport)
    ...
    set(Qt5EventDispatcherSupport_PRIVATE_INCLUDE_DIRS
        "${_qt5EventDispatcherSupport_install_prefix}/include/QtEventDispatcherSupport/5.13.1"
        "${_qt5EventDispatcherSupport_install_prefix}/include/QtEventDispatcherSupport/5.13.1/QtEventDispatcherSupport"
    )
    ...
    foreach(_module_dep ${_Qt5EventDispatcherSupport_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.13.1 ${_Qt5EventDispatcherSupport_FIND_VERSION_EXACT}
