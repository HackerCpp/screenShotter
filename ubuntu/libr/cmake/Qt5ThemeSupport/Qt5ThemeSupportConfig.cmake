...
set(Qt5ThemeSupport_VERSION_STRING 5.13.1)
...
function(_qt5_ThemeSupport_process_prl_file prl_file_location Configuration lib_deps link_flags)
    ...
    get_filename_component(_qt5_install_libs "${_qt5ThemeSupport_install_prefix}/lib" ABSOLUTE)
...
if (NOT TARGET Qt5::ThemeSupport)
    ...
    set(Qt5ThemeSupport_PRIVATE_INCLUDE_DIRS
        "${_qt5ThemeSupport_install_prefix}/include/QtThemeSupport/5.13.1"
        "${_qt5ThemeSupport_install_prefix}/include/QtThemeSupport/5.13.1/QtThemeSupport"
    )
    ...
    foreach(_module_dep ${_Qt5ThemeSupport_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.13.1 ${_Qt5ThemeSupport_FIND_VERSION_EXACT}
