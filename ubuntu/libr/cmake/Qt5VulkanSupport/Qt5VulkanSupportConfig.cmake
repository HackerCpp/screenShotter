...
set(Qt5VulkanSupport_VERSION_STRING 5.13.1)
...
function(_qt5_VulkanSupport_process_prl_file prl_file_location Configuration lib_deps link_flags)
    ...
    get_filename_component(_qt5_install_libs "${_qt5VulkanSupport_install_prefix}/lib" ABSOLUTE)
        ...
        foreach(_flag ${_static_depends})
            ...
            if(_flag MATCHES "^-l(.*)$")
                ...
                elseif(_lib MATCHES "^pthread$")
                    ...
                    if(_search_paths)
                        find_library(_Qt5VulkanSupport_${Configuration}_${_lib}_PATH ${_lib} HINTS ${_search_paths} NO_DEFAULT_PATH)
                    endif()
...
if (NOT TARGET Qt5::VulkanSupport)
    ...
    set(Qt5VulkanSupport_PRIVATE_INCLUDE_DIRS
        "${_qt5VulkanSupport_install_prefix}/include/QtVulkanSupport/5.13.1"
        "${_qt5VulkanSupport_install_prefix}/include/QtVulkanSupport/5.13.1/QtVulkanSupport"
    )
    ...
    foreach(_module_dep ${_Qt5VulkanSupport_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.13.1 ${_Qt5VulkanSupport_FIND_VERSION_EXACT}
