...
QT_MOC_LITERAL(3, 18, 11), // "sendRequest"
QT_MOC_LITERAL(4, 30, 4), // "sent"
QT_MOC_LITERAL(5, 35, 14), // "QNetworkReply*"
QT_MOC_LITERAL(6, 50, 5) // "reply"

    },
    "Request\0finished\0\0sendRequest\0sent\0"
...
void Request::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->sent((*reinterpret_cast< QNetworkReply*(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Request::finished)) {
                *result = 0;
                return;
            }
        }
