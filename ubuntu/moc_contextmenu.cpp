...
QT_MOC_LITERAL(3, 18, 4), // "copy"
QT_MOC_LITERAL(4, 23, 6) // "global"

    },
    "ContextMenu\0save\0\0copy\0global"
};
...
void ContextMenu::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ContextMenu::save)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (ContextMenu::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ContextMenu::copy)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (ContextMenu::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ContextMenu::global)) {
                *result = 2;
                return;
            }
        }
